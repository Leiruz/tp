...
import static hitlist.logic.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
import hitlist.storage.JsonHitListStorage;
import hitlist.storage.JsonUserPrefsStorage;
import hitlist.storage.StorageManager;
...
public class LogicManagerTest {
    ...
    public void getGroupList_modifyList_throwsUnsupportedOperationException() {
        assertThrows(UnsupportedOperationException.class, () -> logic.getGroupList().remove(0));
    }
